...
- Never `rm -r` anything under the game's AddOns folder from WSL; a junction there shows up as a link, and `rm -r` would delete what it points to. `tools/deploy` refuses links for this reason.
